...
import com.example.idletest.data.remote.auth.RegisterRequest
    ...
    fun validateInput(): String? {
        ...
        return when {
            normalizedUsername.length < 3 ->
                "Username-ul trebuie sa aiba cel putin 3 caractere."

            normalizedUsername.length > 50 ->
                "Username-ul poate avea maximum 50 de caractere."

            password.length < 8 ->
                "Parola trebuie sa aiba cel putin 8 caractere."

            password.length > 64 ->
                "Parola poate avea maximum 64 de caractere."
                    ...
                    try {
                        ...
                        errorMessage = when (exception.code()) {
                            ...
                            409 ->
                                ...
                                "Eroare de server: ${exception.code()}."
                        }
                    } catch (_: IOException) {
                        errorMessage =
